            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/user/edit') }}">
                ...
                <div class="form-group{{ $errors->has('fio') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-8 form-inline">
                        <input type="radio" id="client_user" class="form-control" name="type_client" value="1" @if($user->is_person(old('type_client'))) checked @endif> частное лицо
                        <input type="radio" id="client_company" class="form-control" name="type_client" value="2" @if($user->is_company(old('type_client'))) checked @endif> организация
