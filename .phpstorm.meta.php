...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'tracker.config' => \PragmaRX\Support\Config::class,
        'tracker.fileSystem' => \PragmaRX\Support\Filesystem::class,
        'tracker.authentication' => \PragmaRX\Tracker\Services\Authentication::class,
        'tracker.cache' => \PragmaRX\Tracker\Support\Cache::class,
        'tracker.repositories' => \PragmaRX\Tracker\Data\RepositoryManager::class,
        'tracker' => \PragmaRX\Tracker\Tracker::class,
        'tracker.tables.command' => \PragmaRX\Tracker\Vendor\Laravel\Artisan\Tables::class,
        'tracker.updategeoip.command' => \PragmaRX\Tracker\Vendor\Laravel\Artisan\UpdateGeoIp::class,
        'tracker.events' => \PragmaRX\Tracker\Eventing\EventStorage::class,
        'datatables' => \Bllim\Datatables\Datatables::class,
        'tracker.messages' => \PragmaRX\Tracker\Repositories\Message::class,
